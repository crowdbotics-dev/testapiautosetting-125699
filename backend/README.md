...
## Project Structure
    ...
    ├── testapiautosetting_125699  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125699`
...
2. Clone this repo and `cd testapiautosetting_125699`
